...
if (CARDS.length !== 238 || new Set(CARDS.map((card) => card.id)).size !== 238) {
  throw new Error('El catálogo debe contener 238 cartas (90 de NEX-01, 24 de NEX-02, 31 de NEX-03, 31 de NEX-04, 31 de NEX-05 y 31 de NEX-06) con identificadores únicos.');
}
