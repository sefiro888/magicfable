...
if (CARDS.length !== 176 || new Set(CARDS.map((card) => card.id)).size !== 176) {
  throw new Error('El catálogo debe contener 176 cartas (90 de NEX-01, 24 de NEX-02, 31 de NEX-03 y 31 de NEX-04) con identificadores únicos.');
}
